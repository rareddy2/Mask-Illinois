...
export default ({
  ...
  const cards = [
    {
       imageSrc: "https://mediad.publicbroadcasting.net/p/shared/npr/styles/placed_wide/nprshared/202009/916601437.jpg",
      company: "Recent Spike In Cases",
      title: "A Tale Of Two Schools: COVID-19 Testing On Illinois Campuses",
      durationText: "Current",
      locationText: "United States",
      url: "https://www.wglt.org/post/tale-two-schools-covid-19-testing-illinois-campuses#stream/0",
    },
    {
      ...
      title: "Non-profits around the world are currently accepting donations.",
      durationText: "Current",
      locationText: "Sudan",
        ...
        <ThreeColumn>
          <HeadingColumn textOnLeft={textOnLeft}>
            <HeadingInfoContainer>
              ...
              <PrimaryLink onClick={()=> window.open('https://worldrelief.org/covid-19/', "_blank")}>
