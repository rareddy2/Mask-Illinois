...
class Edit extends Component {
  ...
  componentDidMount() {
    axios.get('https://maskillinois.web.illinois.edu/get-user-data',{
  ...
  handleSubmit = (event) => {
    ...
    if(validateForm(this.state.errors)) {
      ...
      axios({
        method: 'post',
        url: 'https://maskillinois.web.illinois.edu/update',
    ...
    return (
      <div className='wrapper'>
        <div className='form-wrapper'>
            ...
            <button type="button" onClick = {this.remove_pic}> Remove Picture </button>
            </div> <br />
