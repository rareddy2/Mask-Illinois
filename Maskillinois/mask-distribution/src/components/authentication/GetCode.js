...
class GetCode extends Component {
  ...
  get_check_exist = (email) => {
    return axios.get('https://maskillinois.web.illinois.edu/check-exist', {
                params: {email: email, }
  ...
  handleSubmit = async(event) => {
    ...
    if(!this.state.check_exist) {
      ...
      axios({
        method: 'post',
        url: 'https://maskillinois.web.illinois.edu/forgot',
  ...
  check_login = (email, password) => {
    return axios.get('https://maskillinois.web.illinois.edu/login', {
