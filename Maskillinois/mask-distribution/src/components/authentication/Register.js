...
class Register extends Component {
  ...
  handleSubmit = (event) => {
    ...
    if(validateForm(this.state.errors)) {
      ...
      axios({
        method: 'post',
        url: 'https://maskillinois.web.illinois.edu/insert',
  ...
  render() {
    ...
    let {profile_picture} = this.state;
      ...
      if (profile_picture) {
        ...
        $profile_picture = (<div className="previewText"> Upload a picture of your mask(s) </div>);
      }
    return (
          ...
          <form onSubmit={this.handleSubmit}>
            <div className = "left-column">
              <div className="previewComponent">
                ...
                <button type="button-remove-pic" onClick = {this.remove_pic}> Remove Picture </button>
              </div> <br />
              ...
              <div className='password'>
                ...
                <input type='password' name='password' onChange={this.handleChange} noValidate required />
                {errors.password.length > 0 && 
                  <span className='error'>{errors.password}</span>}
              </div>
              <div className='confirm_password'>
                <label htmlFor="confirm_password">Confirm Password <b className = 'red'> * </b> </label>
                <input type='password' name='confirm_password' onChange={this.handleChange} noValidate required />
